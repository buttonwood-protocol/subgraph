...
export class Factory extends Entity {
  ...
  save(): void {
    ...
    assert(
      ...
      "Cannot save Factory entity with non-string ID. " + 'Considering using .toHex() to convert the "id" to a string.',
    );
...
export class Tranche extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Tranche entity with non-string ID. " + 'Considering using .toHex() to convert the "id" to a string.',
    );
...
export class Bond extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save Bond entity with non-string ID. " + 'Considering using .toHex() to convert the "id" to a string.',
    );
