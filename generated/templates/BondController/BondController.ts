...
export class BondController extends ethereum.SmartContract {
  ...
  collateralToken(): Address {
    let result = super.call("collateralToken", "collateralToken():(address)", []);

    return result[0].toAddress();
  }

  try_collateralToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("collateralToken", "collateralToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  trancheTokenAddresses(param0: Address): boolean {
    let result = super.call("trancheTokenAddresses", "trancheTokenAddresses(address):(bool)", [
  ...
  try_trancheTokenAddresses(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("trancheTokenAddresses", "trancheTokenAddresses(address):(bool)", [
      ethereum.Value.fromAddress(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  tranches(param0: BigInt): BondController__tranchesResult {
    ...
    return new BondController__tranchesResult(result[0].toAddress(), result[1].toBigInt());
  }

  try_tranches(param0: BigInt): ethereum.CallResult<BondController__tranchesResult> {
    let result = super.tryCall("tranches", "tranches(uint256):(address,uint256)", [
      ethereum.Value.fromUnsignedBigInt(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(new BondController__tranchesResult(value[0].toAddress(), value[1].toBigInt()));
  }
}
